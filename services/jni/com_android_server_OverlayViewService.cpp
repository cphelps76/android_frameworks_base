...
#include "overlayview/audio_global_cfg.h"
#include "overlayview/audiodsp_control.h"
#include "overlayview/audio_utils_ctl.h"
#include "overlayview/mAlsa.h"
...
static void deinit(void)
{
	...
	// send_command("/sys/class/it660x/it660x_hdmirx0/enable", "0");
}
...
int register_android_server_OverlayViewService(JNIEnv* env)
{
	return jniRegisterNativeMethods(env, "com/android/server/OverlayViewService",
