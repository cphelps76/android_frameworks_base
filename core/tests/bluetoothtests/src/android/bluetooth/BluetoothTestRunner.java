 ...
 *     [-e enable_radio_iterations<iterations>] \
...
public class BluetoothTestRunner extends InstrumentationTestRunner {
    ...
    public static int sEnableRadioIterations = 100;
    ...
    public void onCreate(Bundle arguments) {
        ...
        val = arguments.getString("enable_radio_iterations");
        if (val != null) {
            try {
                sEnableRadioIterations = Integer.parseInt(val);
            } catch (NumberFormatException e) {
                // Invalid argument, fall back to default value
            }
        }
