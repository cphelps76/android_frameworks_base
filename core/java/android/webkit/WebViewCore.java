...
public final class WebViewCore {
    ...
    private native void nativeContentInvalidatePartial(int nativeClass);
    ...
    */
    ...
    public class EventHub implements WebViewInputDispatcher.WebKitCallbacks {
        ...
        static final int CONTENT_INVALIDATE_PARTIAL = 176;
        // Geolocation
            ...
            mHandler = new Handler() {
                ...
                public void handleMessage(Message msg) {
                    ...
                    switch (msg.what) {
                        ...
                        case CONTENT_INVALIDATE_PARTIAL:
                            nativeContentInvalidatePartial(mNativeClass);
                            break;
