...
public class HTML5VideoFullScreen extends HTML5VideoView
    ...
    View.OnTouchListener, View.OnLayoutChangeListener ,View.OnKeyListener{
    ...
    //use system write to set property for hiding navigation bar
    private SystemWriteManager sw = null;
    private boolean propBac = false;
    ...
    SurfaceHolder.Callback mSHCallback = new SurfaceHolder.Callback()
    {
        ...
        {
            if(sw != null) {
                propBac = sw.getPropertyBoolean("persist.sys.hideStatusBar", false);
        ...
        public void surfaceDestroyed(SurfaceHolder holder)
        {
            if(sw != null) {
                ...
                sw.setProperty("persist.sys.hideStatusBar",propStr);
            }
    ...
    private final WebChromeClient.CustomViewCallback mCallback =
        new WebChromeClient.CustomViewCallback() {
            ...
            public void onCustomViewHidden() {
                boolean isalwaysfull=!SystemProperties.getBoolean("media.html5videowin.enable",false);
    ...
    public void enterFullScreenVideoState(int layerId,
        ...
        if(mProxy != null) {
            sw = (SystemWriteManager) mProxy.getContext().getSystemService("system_write");
        }
