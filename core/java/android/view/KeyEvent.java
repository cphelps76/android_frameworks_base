...
public class KeyEvent extends InputEvent implements Parcelable {
    ...
    public static final int KEYCODE_UI_SETTING         = 220;
    public static final int KEYCODE_UI_MUSIC           = 221;
    public static final int KEYCODE_UI_GALLERY         = 222;
    public static final int KEYCODE_UI_ALLAPPS	        = 223;
    public static final int KEYCODE_UI_USEFULWEB       = 224;
    public static final int KEYCODE_UI_VIDEOPLAYER     = 225;
    public static final int KEYCODE_UI_FILEBROWSER     = 233;

    public static final int KEYCODE_UI_SUBTITLE     = 245;
    public static final int KEYCODE_UI_AUDIO     = 246;
    ...
    private static void populateKeycodeSymbolicNames() {
		...
		names.append(KEYCODE_UI_SETTING, "KEYCODE_UI_SETTING");
		names.append(KEYCODE_UI_MUSIC, "KEYCODE_UI_MUSIC");
		names.append(KEYCODE_UI_GALLERY, "KEYCODE_UI_GALLERY");
		names.append(KEYCODE_UI_ALLAPPS, "KEYCODE_UI_ALLAPPS");
		names.append(KEYCODE_UI_USEFULWEB, "KEYCODE_UI_USEFULWEB");
		names.append(KEYCODE_UI_VIDEOPLAYER, "KEYCODE_UI_VIDEOPLAYER");
		names.append(KEYCODE_UI_FILEBROWSER, "KEYCODE_UI_FILEBROWSER");
		names.append(KEYCODE_UI_SUBTITLE, "KEYCODE_UI_SUBTITLE");
		names.append(KEYCODE_UI_AUDIO, "KEYCODE_UI_AUDIO");
