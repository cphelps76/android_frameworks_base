...
public class PhoneWindowManager implements WindowManagerPolicy {
    ...
    public void setInitialDisplaySize(Display display, int width, int height, int density) {
		...
		if(SystemProperties.getBoolean("ro.ui.tabletui",false)){
...
//        }
    ...
    public void layoutWindowLw(WindowState win, WindowManager.LayoutParams attrs,
		...
		{
			//Log.v(TAG,"mRestrictedScreenHeight "+mRestrictedScreenHeight+"mRestrictedScreenTop "+mRestrictedScreenTop);
			//Log.v(TAG,"mUnrestrictedScreenHeight "+mUnrestrictedScreenHeight+"mUnrestrictedScreenTop "+mUnrestrictedScreenTop);
			//Log.v(TAG,"mRestrictedScreenLeft "+mRestrictedScreenLeft+"mRestrictedScreenWidth "+mRestrictedScreenWidth);+						 
			//Log.v(TAG,"mUnrestrictedScreenLeft "+mUnrestrictedScreenLeft+"mUnrestrictedScreenWidth "+mUnrestrictedScreenWidth);
    ...
    void setHdmiHwPlugged(boolean plugged) {
        if (mHdmiHwPlugged != plugged) {
            ...
            mContext.sendStickyBroadcastAsUser(intent, new UserHandle(UserHandle.USER_CURRENT));
            ...
            if (SystemProperties.getBoolean("ro.vout.dualdisplay", false)) {
                ...
                mContext.sendStickyBroadcastAsUser(it, new UserHandle(UserHandle.USER_CURRENT));
            }
        }
    }
