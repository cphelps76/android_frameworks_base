...
public class PhoneWindow extends Window implements MenuBuilder.Callback {
    ...
    protected boolean onKeyDown(int featureId, int keyCode, KeyEvent event) {
        ...
        //Log.i(TAG, "Key down: repeat=" + keyCode);
        switch (keyCode) {

	   case KeyEvent.KEYCODE_UI_SETTING:
		{
	    ...
	    case KeyEvent.KEYCODE_UI_MUSIC:
		{
		Intent intent = new Intent();
		try{
	    ...
	    case KeyEvent.KEYCODE_UI_GALLERY:
		{
		Intent intent = new Intent();
		try{
	    ...
	    case KeyEvent.KEYCODE_UI_ALLAPPS:
		{
		Intent intent = new Intent();
		//intent .setComponent(new ComponentName("com.launcher", "com.launcher.AllAppsActivity"));
		intent .setComponent(new ComponentName("com.android.wyst", "com.android.wyst.AllApps3D"));
		getContext().startActivity(intent);
		return true;
		}
	    case KeyEvent.KEYCODE_UI_USEFULWEB:
		{
		Intent intent = new Intent();
		intent .setComponent(new ComponentName("com.commonweb", "com.commonweb.UsefulWebpageActivity"));
		getContext().startActivity(intent);
		return true;
		}
	    case KeyEvent.KEYCODE_UI_VIDEOPLAYER:
		{
		Intent intent = new Intent();
	    ...
	    case KeyEvent.KEYCODE_UI_FILEBROWSER:
		{
		Intent intent = new Intent();
